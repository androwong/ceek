			...
			submitHandler: function(ev)
			{
				...
				*/
				...
				setTimeout(function()
				{
					...
					$.ajax({
						url: baseurl + 'index.php?page=info&type=sample-connect-form',
						method: 'POST',
						dataType: 'json',
						data: {
							db_host: $("input#hostname").val(),
							db_port: $("input#port").val(),
							db_user: $("input#user").val(),
							db_pass: $("input#pass").val(),
							db_database: $("input#database").val(),
						},
						error: function()
						{
