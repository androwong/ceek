...
?>
	<div class="row">
		...
		<div class="col-md-6 col-sm-4 clearfix hidden-xs">
			...
			<ul class="list-inline links-list pull-right">
				...
				<li>
					<a href="<?php echo WEB_PATH; ?>index.php?page=logout">
	...
	<?php if($flag_breadcrumb){ ?>

	<ol class="breadcrumb bc-3" >
		<li>
			<a href="<?php echo WEB_PATH; ?>index.php"><i class="fa-home"></i>Home</a>
		</li>
		<li class="active">
	...
	<h2><?php echo str_ireplace("Ceek - ", "", $page_title); ?></h2>
	<br />
